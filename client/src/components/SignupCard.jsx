          ...
          <div className="text-center lg:text-left relative z-10">
            <div className="bg-black bg-opacity-55 backdrop-blur-sm p-6 rounded-lg shadow-lg">
              <h1 className="text-5xl font-bold text-white">
                {isOrgSignUp ? 'Register Your Organization Now!' : 'Become a member today!'}
              </h1>
                ...
                <fieldset className="fieldset">
                  ...
                  <div>
                    Registering as a volunteer?
                      {' '}
                    <Link to="/signup" className="text-[#7539C2]">Sign Up</Link>
                  </div>
                  :<div>
                    Registering as an organization?
                      {' '}
                    <Link to="/signuporg" className="text-[#7539C2]">Register</Link>
                  </div>}
                  <div>
                    Have an account?
                      {' '}
